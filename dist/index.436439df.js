...
console.log(state);
var controlCircleDisplay = function controlCircleDisplay1() {
    if (state.viewportWidth !== window.innerWidth) state.updateDimensions();
    _circlesViewDefault.default.render(state);
};
var controlActiveCells = function controlActiveCells1(e) {
    var cell = e.target;
    if (!cell.classList.contains('circle__cell')) return; // Remove focus from button
    cell.blur();
    var cellsArray = state.cellsArray, rhythmAudio = state.rhythmAudio;
    var cellNum = cell.dataset.cellNum;
...
var controlShiftForward = function controlShiftForward1() {
    _model.shiftForward();
    _circlesViewDefault.default.updateActiveDisplay(state.cellsArray);
};
var controlShiftBackward = function controlShiftBackward1() {
    _model.shiftBackward();
    _circlesViewDefault.default.updateActiveDisplay(state.cellsArray);
};
var controlCreateCtx = function controlCreateCtx1() {
    _model.createContext();
    _playStopViewDefault.default.removeHandlerCreateCtx(controlCreateCtx1);
    _playStopViewDefault.default.addHandlerStartStop(controlStartStop);
    controlInitDisplay();
};
var controlStartStop = function controlStartStop1() {
    var isPlaying = state.timer;
    if (isPlaying) {
...
var controlSequence = function controlSequence1(time) {
    // Play accented pulse sound for the first pulse beat of the bar
    if (state.currentNote === 0) state.pulseAudioHigh.play(time);
    else if (state.currentNote !== 0 && state.currentNote % state.pulseBeats === 0) state.pulseAudioLow.play(time);
     // Play wood block sound if current cell is on
    if (state.cellsArray[state.currentNote]) state.rhythmAudio.play(time);
};
var controlSetNextNote = function controlSetNextNote1() {
    var secondsPerBeat = state.BPM * state.pulseBeats / 1000;
...
var controlPlaySequence = function controlPlaySequence1() {
    while(state.nextNoteTime < state.ctx.currentTime + _config.SCHEDULE_TIME){
        controlSequence(state.nextNoteTime);
        _circlesViewDefault.default.updateCurrentDisplay(state.currentNote);
        controlSetNextNote();
    }
    clearInterval(state.timer);
    var timer = setInterval(controlPlaySequence1, 50);
    state.setTimer(timer);
};
var controlStopSequence = function controlStopSequence1() {
    _circlesViewDefault.default.updateCurrentDisplay(state.currentNote, false);
    clearInterval(state.timer);
    state.setCurrentNote(0);
    state.resetTimer();
};
var controlCreateControls = function controlCreateControls1() {
    var controls = [];
    var pulseGain = new _controlViewDefault.default('pulseGain', 0, 100, 'Pulse Volume', 'pulse');
    var rhythmGain = new _controlViewDefault.default('rhythmGain', 0, 100, 'Rhythm Volume', 'drumsticks');
    var tempo = new _controlViewDefault.default('tempo', 40, 240, 'Tempo', 'metronome');
    controls.push(pulseGain, rhythmGain, tempo);
    _controlsBoxViewDefault.default.render(controls);
};
var controlControlValueChange = function controlControlValueChange1(e) {
    var ctrl = e.target;
    var value = +ctrl.value;
    var controlName = ctrl.closest('.control').id;
...
var controlInitDisplay = function controlInitDisplay1() {
...
},{"core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq","./model":"6Yfb5","./view/circlesView":"kIYbb","./view/shiftView":"98JRs","./view/playStopView":"leAse","./view/controlsBoxView":"dUzN4","./view/controlView":"9XWnt","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./config":"beA2m"}],"eIyVg":[function(require,module,exports) {
...
var state = new _stateDefault.default(16, 4, 120);
var shiftForward = function shiftForward1() {
    var cellsArray = state.cellsArray; // Create new array with values from the first to the penultimate values from cellsArray
    var newCellsArr = cellsArray.slice(0, cellsArray.length - 1); // Add the last value of cellsArray to the start of the new array
    newCellsArr.unshift(cellsArray[cellsArray.length - 1]); // Update values of cellsArray
    state.updateCellsArray(newCellsArr);
};
var shiftBackward = function shiftBackward1() {
    var cellsArray = state.cellsArray; // Create new array with values from the second to the penultimate values from cellsArray
    var newCellsArr = cellsArray.slice(1); // Add the first value of cellsArray to the end of the new array
    newCellsArr.push(cellsArray[0]); // Update values of cellsArray
    state.updateCellsArray(newCellsArr);
};
var createContext = function createContext1() {
    var AudioContext1 = window.AudioContext || window.webkitAudioContext;
    state.ctx = new AudioContext1();
    createAudio();
};
var createAudio = /*#__PURE__*/ function() {
    ...
    return function createAudio1() {
        return _ref.apply(this, arguments);
    };
}();

},{"@babel/runtime/helpers/asyncToGenerator":"5j50L","@babel/runtime/regenerator":"1L3WO","./model/state":"69WLq","./model/audioObj":"kccok","url:../audio/wood_block.wav":"ijso3","url:../audio/shaker_high.wav":"jqm0i","url:../audio/shaker_low.wav":"ae0Nb","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"5j50L":[function(require,module,exports) {
...
},{"regenerator-runtime":"cH8Iq"}],"69WLq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var State = /*#__PURE__*/ function() {
    function State1(numOfBeats, pulseBeats, BPM) {
        _classCallCheckDefault.default(this, State1);
        _definePropertyDefault.default(this, "timer", void 0);
        _definePropertyDefault.default(this, "currentNote", 0);
    ...
    _createClassDefault.default(State1, [
        {
            key: "_getBoxSize",
            value: function _getBoxSize() {
        ...
        {
            key: "setCurrentNote",
            value: function setCurrentNote(num) {
                return this.currentNote = num;
            }
        },
        {
            key: "setNextNoteTime",
            value: function setNextNoteTime(time) {
        ...
        {
            key: "updateCellsArray",
            value: function updateCellsArray(newArray) {
                this.cellsArray = _toConsumableArrayDefault.default(newArray);
            }
        },
        {
...
},{"@babel/runtime/helpers/toConsumableArray":"8RnnL","@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/helpers/defineProperty":"eCMPI","./getCoords":"gccGz","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8RnnL":[function(require,module,exports) {
...
},{}],"7v4AM":[function(require,module,exports) {
...
},{"./arrayLikeToArray.js":"cF1Zj"}],"8Qwv0":[function(require,module,exports) {
...
},{}],"gccGz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
exports.default = function(numOfBeats, boxSize) {
    var centreX = boxSize / 2;
    var centreY = boxSize / 2;
    var radius = boxSize / 2 * _config.OUTER_CIRCLE_DIAMETER;
    var cellCoords = [];
    for(var i = 0; i < numOfBeats; i++){
        var x = centreX + radius * Math.cos(2 * Math.PI * i / numOfBeats);
        var y = centreY + radius * Math.sin(2 * Math.PI * i / numOfBeats);
        cellCoords.push([
            x,
            y
        ]);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SCHEDULE_TIME", ()=>SCHEDULE_TIME
);
...
var SCHEDULE_TIME = 0.1; // Initial gain value for audio objects
var INITIAL_GAIN_VALUE = 0.5; // Diameters of circles as a percentage of outer container width
var OUTER_CIRCLE_DIAMETER = 0.8;
var PULSE_BEAT_CIRCLE_DIAMETER = 0.13;
var SUBDIVISION_CIRCLE_DIAMETER = 0.1;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>AudioObj
);
var _asyncToGenerator = require("@babel/runtime/helpers/asyncToGenerator");
var _asyncToGeneratorDefault = parcelHelpers.interopDefault(_asyncToGenerator);
var _classCallCheck = require("@babel/runtime/helpers/classCallCheck");
...
var _regeneratorDefault = parcelHelpers.interopDefault(_regenerator);
var _config = require("../config");
var AudioObj = /*#__PURE__*/ function() {
    function AudioObj1(url) {
        _classCallCheckDefault.default(this, AudioObj1);
        this._url = url;
    }
    _createClassDefault.default(AudioObj1, [
        {
            key: "createAudio",
            value: function() {
                var _createAudio = _asyncToGeneratorDefault.default(/*#__PURE__*/ _regeneratorDefault.default.mark(function _callee(ctx) {
                    return _regeneratorDefault.default.wrap(function _callee$(_context) {
                        while(true)switch(_context.prev = _context.next){
                            case 0:
                                _context.prev = 0;
                            ...
                            case 4:
                                this._file = _context.sent;
                                _context.next = 7;
                                return this._file.arrayBuffer();
                            case 7:
                                this._buffer = _context.sent;
                                _context.next = 10;
                                return this._ctx.decodeAudioData(this._buffer);
                            case 10:
                                this._audio = _context.sent;
        ...
        },
        {
            key: "play",
            value: function play() {
                var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._ctx.currentTime;
...
},{"@babel/runtime/helpers/asyncToGenerator":"5j50L","@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/regenerator":"1L3WO","../config":"beA2m","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"ijso3":[function(require,module,exports) {
...
var _definePropertyDefault = parcelHelpers.interopDefault(_defineProperty);
var _config = require("../config");
var CirclesView = /*#__PURE__*/ function() {
    function CirclesView1() {
        _classCallCheckDefault.default(this, CirclesView1);
        _definePropertyDefault.default(this, "_parentElement", document.querySelector('.circle__box'));
        _definePropertyDefault.default(this, "_circles", void 0);
        _definePropertyDefault.default(this, "_data", void 0);
    }
    _createClassDefault.default(CirclesView1, [
        {
        ...
        {
            key: "addHandlerToggleOnOff",
            value: function addHandlerToggleOnOff(handler) {
                this._parentElement.addEventListener('click', handler);
            }
        },
        {
            key: "addActiveClass",
            value: function addActiveClass(cellNum) {
                this._circles[cellNum].classList.add('circle__cell--on');
            }
        },
        {
            key: "removeActiveClass",
            value: function removeActiveClass(cellNum) {
                this._circles[cellNum].classList.remove('circle__cell--on');
            }
        },
        {
            key: "updateActiveDisplay",
            value: function updateActiveDisplay(cellsArray) {
                var _this = this;
                this._circles.forEach(function(_, i) {
                    if (cellsArray[i]) _this.addActiveClass(i);
                    if (!cellsArray[i]) _this.removeActiveClass(i);
                });
            }
        },
        {
            key: "updateCurrentDisplay",
            value: function updateCurrentDisplay(currentNote) {
                var isPlaying = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
                // Add current note style if sequence is playing
                if (isPlaying) this._circles[currentNote].classList.add('circle__cell--current'); // Remove current note style from previous beat, either the currentNote - 1,
        ...
        {
            key: "revealAnimation",
            value: function revealAnimation() {
                this._circles.forEach(function(cell, i) {
                    setTimeout(function() {
        ...
        },
        {
            ...
            value: function render(data) {
                if (!data) return;
                this._data = data;
                this._parentElement.style.width = "".concat(this._data.boxSize, "px");
                this._parentElement.style.height = "".concat(this._data.boxSize, "px");
        ...
        },
        {
            ...
            value: function _generateMarkup() {
                var _this2 = this;
                return this._data.cellCoords.map(function(_ref, i) {
                    var _ref2 = _slicedToArrayDefault.default(_ref, 2), x = _ref2[0], y = _ref2[1];
                    var radius = _this2._data.boxSize / 2 * (i % _this2._data.pulseBeats === 0 ? _config.PULSE_BEAT_CIRCLE_DIAMETER : _config.SUBDIVISION_CIRCLE_DIAMETER);
                    return "\n          <button data-cell-num=\"".concat(i, "\" aria-label=\"Toggle beat ").concat(i + 1, " on or off\" \n            class=\"btn circle__cell ").concat(_this2._data.ctx ? '' : 'u-hidden u-transparent', "\" \n            style=\"\n              height: ").concat(radius * 2, "px;\n              width: ").concat(radius * 2, "px;\n              left: ").concat(x - radius, "px;\n              top: ").concat(y - radius, "px;\n            \">\n          </button> ");
                }).join('');
            }
        }
    ]);
...
},{"@babel/runtime/helpers/slicedToArray":"ePN39","@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/helpers/defineProperty":"eCMPI","../config":"beA2m","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"ePN39":[function(require,module,exports) {
...
},{}],"98JRs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _classCallCheck = require("@babel/runtime/helpers/classCallCheck");
var _classCallCheckDefault = parcelHelpers.interopDefault(_classCallCheck);
...
var _defineProperty = require("@babel/runtime/helpers/defineProperty");
var _definePropertyDefault = parcelHelpers.interopDefault(_defineProperty);
var ShiftView = /*#__PURE__*/ function() {
    function ShiftView1() {
        _classCallCheckDefault.default(this, ShiftView1);
        _definePropertyDefault.default(this, "_forwardBtn", document.querySelector('.btn--plus'));
        _definePropertyDefault.default(this, "_backwardBtn", document.querySelector('.btn--minus'));
    }
    _createClassDefault.default(ShiftView1, [
        {
            key: "addHandlerShiftForward",
            value: function addHandlerShiftForward(handler) {
                this._forwardBtn.addEventListener('click', handler);
            }
        },
        {
            key: "addHandlerShiftBackward",
            value: function addHandlerShiftBackward(handler) {
                this._backwardBtn.addEventListener('click', handler);
            }
        },
        {
            key: "removeHidden",
            value: function removeHidden() {
...
},{"@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/helpers/defineProperty":"eCMPI","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"leAse":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _classCallCheck = require("@babel/runtime/helpers/classCallCheck");
var _classCallCheckDefault = parcelHelpers.interopDefault(_classCallCheck);
...
var _defineProperty = require("@babel/runtime/helpers/defineProperty");
var _definePropertyDefault = parcelHelpers.interopDefault(_defineProperty);
var PlayStopView = /*#__PURE__*/ function() {
    function PlayStopView1() {
        _classCallCheckDefault.default(this, PlayStopView1);
        _definePropertyDefault.default(this, "_parentElement", document.querySelector('.btn--play-stop'));
    }
    _createClassDefault.default(PlayStopView1, [
        {
            key: "addHandlerCreateCtx",
            value: function addHandlerCreateCtx(handler) {
                this._parentElement.addEventListener('click', handler);
            }
        },
        {
            key: "removeHandlerCreateCtx",
            value: function removeHandlerCreateCtx(handler) {
                this._parentElement.removeEventListener('click', handler);
            }
        },
        {
            key: "addHandlerStartStop",
            value: function addHandlerStartStop(handler) {
                var _this = this;
                this._parentElement.addEventListener('click', function() {
                    _this._parentElement.blur();
                    handler();
                });
        ...
        {
            key: "toggleBtnText",
            value: function toggleBtnText(isPlaying) {
                var text = isPlaying ? 'Play' : 'Stop';
                this._parentElement.innerHTML = "<p class=\"btn__text\">".concat(text, "</p>");
            }
        },
        {
            key: "beginAnimation",
    ...
    return PlayStopView1;
}();
exports.default = new PlayStopView();

},{"@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/helpers/defineProperty":"eCMPI","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"dUzN4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _classCallCheck = require("@babel/runtime/helpers/classCallCheck");
var _classCallCheckDefault = parcelHelpers.interopDefault(_classCallCheck);
...
var _defineProperty = require("@babel/runtime/helpers/defineProperty");
var _definePropertyDefault = parcelHelpers.interopDefault(_defineProperty);
var ControlsBox = /*#__PURE__*/ function() {
    function ControlsBox1() {
        _classCallCheckDefault.default(this, ControlsBox1);
        _definePropertyDefault.default(this, "_parentElement", document.querySelector('.container__controls'));
        _definePropertyDefault.default(this, "_data", void 0);
    }
    _createClassDefault.default(ControlsBox1, [
        {
            key: "addHandlerValueChange",
            value: function addHandlerValueChange(handler) {
                this._parentElement.addEventListener('input', handler);
            }
        },
        {
            key: "updateValue",
            value: function updateValue(controlName, value) {
                var ctrl = this._data.find(function(ctrlObj) {
                    return controlName === ctrlObj._name;
                });
                ctrl.setValue(value);
            }
        },
        {
            key: "removeHidden",
            value: function removeHidden() {
                var hidden = Array.from(this._parentElement.querySelectorAll('.u-hidden.control'));
                hidden.forEach(function(control) {
                    return control.classList.remove('u-hidden', 'u-transparent');
                });
            }
        },
        {
            ...
            value: function render(data) {
                ...
                var markup = this._generateMarkup();
                this._parentElement.innerHTML = markup;
                var controls = this._parentElement.querySelectorAll('.control');
                controls.forEach(function(control) {
                    var ctrl = _this._data.find(function(ctrlObj) {
                        return control.id === ctrlObj._name;
                    });
        ...
        },
        {
            key: "_generateMarkup",
            value: function _generateMarkup() {
                return this._data.map(function(control) {
                    return control.generateMarkup(control);
                }).join('');
            }
        }
    ]);
...
},{"@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","@babel/runtime/helpers/defineProperty":"eCMPI","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"9XWnt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Control
);
var _classCallCheck = require("@babel/runtime/helpers/classCallCheck");
var _classCallCheckDefault = parcelHelpers.interopDefault(_classCallCheck);
var _createClass = require("@babel/runtime/helpers/createClass");
var _createClassDefault = parcelHelpers.interopDefault(_createClass);
var _iconsSvg = require("url:../../icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var Control = /*#__PURE__*/ function() {
    function Control1(name, min, max, label, icon) {
        _classCallCheckDefault.default(this, Control1);
        this._name = name;
        this._min = min;
        this._max = max;
        this._label = label;
    ...
    _createClassDefault.default(Control1, [
        {
            key: "setValue",
            value: function setValue(value) {
                var input = this._parentElement.querySelector("#".concat(this._name, "Input"));
                var slider = this._parentElement.querySelector("#".concat(this._name, "Slider"));
        ...
        },
        {
            ...
            value: function generateMarkup() {
                return "\n\t\t\t<div class=\"control u-hidden u-transparent\" id=\"".concat(this._name, "\">\n\t\t\t\t<label for=\"").concat(this._name, "Input\" aria-label=\"").concat(this._label, " input\" class=\"control__label\">\n\t\t\t\t\t<svg class=\"icon icon__control\">\n\t\t\t\t\t\t<use href=\"").concat(_iconsSvgDefault.default, "#icon-").concat(this._icon, "\"></use>\n\t\t\t\t\t</svg>\n\t\t\t\t</label>\n\t\t\t\t<input\n\t\t\t\t\tid=\"").concat(this._name, "Input\"\n\t\t\t\t\ttype=\"text\"\n\t\t\t\t\tplaceholder=\"").concat(this._max / 2, "\"\n\t\t\t\t\tclass=\"control__input\"\n\t\t\t\t\tdata-control=\"").concat(this._name, "\"\n\t\t\t\t/>\n\t\t\t\t<input\n\t\t\t\t\taria-label=\"").concat(this._label, " range slider\"\n\t\t\t\t\ttype=\"range\"\n\t\t\t\t\tmin=\"").concat(this._min, "\"\n\t\t\t\t\tmax=\"").concat(this._max, "\"\n\t\t\t\t\tstep=\"1\"\n\t\t\t\t\tid=\"").concat(this._name, "Slider\"\n\t\t\t\t\tclass=\"control__slider\"\n\t\t\t\t\tdata-control=\"").concat(this._name, "\"\n\t\t\t\t/>\n\t\t\t</div>\n\t\t");
            }
        }
    ]);
    return Control1;
...
},{"@babel/runtime/helpers/classCallCheck":"fIqcI","@babel/runtime/helpers/createClass":"eFNXV","url:../../icons.svg":"bUrM0","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"bUrM0":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('8LZRF') + "icons.af522834.svg";

},{"./helpers/bundle-url":"8YnfL"}]},["drOo7","jKMjS"], "jKMjS", "parcelRequirede53")
