 ...
 */ const controlActiveCells = function(e) {
    ...
    _circlesViewDefault.default.updateActiveDisplay(cellsArray); // Once the context has been created, if the current cell is active then play the rhythm audio.
 ...
 */ const controlScheduleSequence = function() {
    while(state.nextNoteTime < state.ctx.currentTime + _config.SCHEDULER_LOOKAHEAD){
        controlSequence(state.nextNoteTime);
        _circlesViewDefault.default.updateCurrentDisplay(state.currentNote);
        controlSetNextNote();
    }
    clearInterval(state.timer);
    const timer = setInterval(controlScheduleSequence, _config.SCHEDULER_INTERVAL);
 ...
 */ const controlCreateControls = function() {
    const controls = [];
    const tempo = new _controlViewDefault.default('tempo', 40, 240, 'Tempo', 'metronome', 'minus-circle', 'add-circle');
    const pulseGain = new _controlViewDefault.default('pulseGain', 0, 100, 'Pulse volume', 'pulse', 'speaker-quieter', 'speaker-louder');
    const rhythmGain = new _controlViewDefault.default('rhythmGain', 0, 100, 'Rhythm volume', 'drumsticks', 'speaker-quieter', 'speaker-louder');
...
},{"core-js/stable":"95FYz","regenerator-runtime/runtime":"1EBPE","./model":"1pVJj","./view/circlesView":"ggE08","./view/shiftView":"4u8Sh","./view/playStopView":"49uXO","./view/controlsBoxView":"c71zr","./view/controlView":"emyJj","./config":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"95FYz":[function(require,module,exports) {
...
const shiftForward = function() {
    const { cellsArray  } = state; // Create new array with values from the first to the penultimate values from cellsArray
    const newCellsArr = cellsArray.slice(0, cellsArray.length - 1); // Add the last value of cellsArray to the start of the new array
...
const shiftBackward = function() {
    const { cellsArray  } = state; // Create new array with values from the second to the penultimate values from cellsArray
    const newCellsArr = cellsArray.slice(1); // Add the first value of cellsArray to the end of the new array
...
},{"./model/state":"ayfN9","./model/audioObj":"81AQO","url:../audio/wood_block.wav":"i8jOe","url:../audio/shaker_high.wav":"4tamL","url:../audio/shaker_low.wav":"eiC61","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ayfN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./getCoords":"jWoLo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jWoLo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
exports.default = function(numOfBeats, boxSize) {
   ...
   *
   */ const radius = boxSize / 2 * _config.OUTER_CIRCLE_DIAMETER;
    const cellCoords = [];
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SCHEDULER_LOOKAHEAD", ()=>SCHEDULER_LOOKAHEAD
);
parcelHelpers.export(exports, "SCHEDULER_INTERVAL", ()=>SCHEDULER_INTERVAL
);
...
},{}],"81AQO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
class AudioObj {
...
},{"../config":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"i8jOe":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('71ti3') + "wood_block.f09d5140.wav" + "?" + Date.now();
...
},{}],"4tamL":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('71ti3') + "shaker_high.cbf83060.wav" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"eiC61":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('71ti3') + "shaker_low.8c2c87e0.wav" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"ggE08":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
/**
...
},{"../config":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4u8Sh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"49uXO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ class PlayStopView {
   ...
   */ addHandlerStartStop(handler) {
        ...
        <svg class="icon icon__playStop icon__playStop--play">
					<use href="${_iconsSvgDefault.default}#icon-play"></use>
				</svg>
      </p>`;
    }
    /**
   ...
   */ toggleBtnText(isPlaying) {
        const icon = isPlaying ? `<svg class="icon icon__playStop icon__playStop--play">
          <use href="${_iconsSvgDefault.default}#icon-play"></use>
        </svg>` : `<svg class="icon icon__playStop icon__playStop--stop">
          <use href="${_iconsSvgDefault.default}#icon-stop"></use>
        </svg>`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"emyJj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
   ...
   */ generateMarkup() {
        return `
			<div class="control u-hidden u-transparent" id="${this._name}">
				<label for="${this._name}Input" aria-label="${this._label} input" class="control__label">
					<svg class="icon icon__control">
						<use href="${_iconsSvgDefault.default}#icon-${this._icon}"></use>
					</svg>
				</label>
				<input
					id="${this._name}Input"
...
},{"url:../../icons.svg":"awZjJ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["kS06O","lA0Es"], "lA0Es", "parcelRequirede53")
